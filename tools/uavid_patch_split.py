...
def padifneeded(image, mask):
    ...
    #                        border_mode=0, value=[0, 0, 0], mask_value=[255, 255, 255])(image=image, mask=mask) # val
    
    pad = albu.PadIfNeeded(min_height=3072, min_width=4096, border_mode=0,
                     position='bottom_right', value=[0, 0, 0], mask_value=[255, 255, 255])(image=image, mask=mask) # test
